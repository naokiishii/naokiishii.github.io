...
Object.defineProperty(commands, "__esModule", {
  value: true
});
commands.COMMANDS = void 0;
// @flow strict
...
var dataTables_dataTables = /*#__PURE__*/Object.freeze({
	__proto__: null,
	default: DataTable
});

var require$$4 = /*@__PURE__*/getAugmentedNamespace(dataTables_dataTables);

Object.defineProperty(help, "__esModule", {
  value: true
});
help.viewHelpPage = void 0;
var _commands$1 = commands;
var _classes$1 = classes;


var _datatables2 = _interopRequireDefault(require$$4);
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
// @flow strict

help.viewHelpPage = function viewHelpPage() {
  console.trace();
  var data = Object.keys(_commands$1.COMMANDS).map(function (command, index, array) {
    var cmdData = _commands$1.COMMANDS[command];
    return {
      name: cmdData.name,
      url: cmdData.url,
      command: command
  ...
  if (typeof window !== 'undefined') {
    new _datatables2["default"]("#help-table", {
      data: data,
      columns: columns,
      order: [[1, "asc"]],
      paging: false
  ...
  var classesData = Object.keys(_classes$1.CLASSES).map(function (command, index, array) {
    var cmdData = _classes$1.CLASSES[command];
    return {
      name: cmdData.name,
      url: cmdData.url,
  ...
  if (typeof window !== 'undefined') {
    new _datatables2["default"]("#classes-table", {
      data: classesData,
...
var _help = help;
var _commandParams$split, _commandParams, _searchParams$split, _searchParams;
...
var bunnylol = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(command, arr) {
    var prefix, classData, _command, protocol;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          if (!(prefix in _classes.CLASSES)) {
            _context2.next = 32;
            break;
          }
          // $FlowFixMe - this is actually correct since the prefix is a key.
          classData = _classes.CLASSES[prefix];
          if (!(arr.length > 1)) {
            _context2.next = 29;
            break;
          }
          ...
          _context2.next = 10;
          return redirect("".concat(classData.zoomurl));
        case 10:
        ...
        case 13:
          ...
          _context2.next = 16;
          return redirect("".concat(classData.discussionurl));
        case 16:
          return _context2.abrupt("return", true);
        case 19:
          if (!(arr[1].toLowerCase() === "c" && classData.collaburl)) {
            _context2.next = 25;
            break;
          }
          _context2.next = 22;
          return redirect("".concat(classData.collaburl));
        case 22:
          return _context2.abrupt("return", true);
        case 25:
          if (!(arr[1].toLowerCase() === "s" && classData.specialurl)) {
            _context2.next = 29;
            break;
          }
          _context2.next = 28;
          return redirect("".concat(classData.specialurl));
        case 28:
          return _context2.abrupt("return", true);
        case 29:
          _context2.next = 31;
          return redirect("".concat(classData.url));
        case 31:
          return _context2.abrupt("return", true);
        case 32:
          ...
          // $FlowFixMe - this is actually correct since the prefix is a key.
          _command = _commands.COMMANDS[prefix];
          protocol = new URL(_command.url).protocol;
          if (protocol !== "https:" && protocol !== "http:") {
            (0, _help.viewHelpPage)();
          }
          if (!(_command.searchurl && arr.length !== 1)) {
            _context2.next = 44;
            break;
          }
          ...
          arr.shift();
          _context2.next = 41;
          return redirect("".concat(_command.searchurl).concat(encodeURIComponent(arr.join(' '))));
        case 41:
          return _context2.abrupt("return", true);
        case 44:
          if (!(arr.length > 1)) {
          ...
          _context2.next = 47;
          return redirect("".concat(_command.url).concat(_command.complement).concat(encodeURIComponent(arr[1])));
        case 47:
          return _context2.abrupt("return", true);
        case 50:
          _context2.next = 52;
          return redirect(_command.url);
        case 52:
          return _context2.abrupt("return", true);
        case 53:
  ...
  return function bunnylol(_x2, _x3) {
    return _ref2.apply(this, arguments);
  };
}();
var searchParams = new URL(window.location.href).searchParams.get("search");
if (searchParams !== null && searchParams !== '') {
  searchParams = searchParams.replace(' ', ',');
}
var commandParams = new URL(window.location.href).searchParams.get("command");
if (commandParams !== null && searchParams !== '') {
  commandParams = commandParams.replace(' ', ',');
}
var command = searchParams ? "search" : commandParams ? "command" : "help";
var params = [];
switch (command) {
  case "help" :
    (0, _help.viewHelpPage)();
    break;
  case "command":
    params = (_commandParams$split = (_commandParams = commandParams) === null || _commandParams === void 0 ? void 0 : _commandParams.split(',')) !== null && _commandParams$split !== void 0 ? _commandParams$split : [];
    bunnylol("command", params).then(function (done) {
      if (!done && _commands.COMMANDS.DEFAULT.searchurl) {
        var _commandParams2;
        redirect("".concat(_commands.COMMANDS.DEFAULT.searchurl).concat(encodeURIComponent((_commandParams2 = commandParams) !== null && _commandParams2 !== void 0 ? _commandParams2 : '')));
      }
    ...
    break;
  default:
    params = (_searchParams$split = (_searchParams = searchParams) === null || _searchParams === void 0 ? void 0 : _searchParams.split(/[ +]/g)) !== null && _searchParams$split !== void 0 ? _searchParams$split : [];
    bunnylol("search", params).then(function (done) {
      if (!done && _commands.COMMANDS.DEFAULT.searchurl) {
        var _searchParams2;
        redirect("".concat(_commands.COMMANDS.DEFAULT.searchurl).concat(encodeURIComponent((_searchParams2 = searchParams) !== null && _searchParams2 !== void 0 ? _searchParams2 : '')));
      }
    })["catch"](function (reject) {
      console.log(reject);
    });
